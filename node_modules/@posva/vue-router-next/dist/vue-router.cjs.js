...
function createRouterMatcher(routes, globalOptions) {
    ...
    function addRoute(record, parent) {
        ...
        for (var _a = 0, normalizedRecords_1 = normalizedRecords; _a < normalizedRecords_1.length; _a++) {
            ...
            if ('children' in record) {
                for (var _b = 0, _c = record.children; _b < _c.length; _b++) {
                    var childRecord = _c[_b];
    ...
    return { addRoute: addRoute, resolve: resolve, removeRoute: removeRoute, getRecordMatcher: getRecordMatcher };
}
/**
...
function decode(text) {
    try {
        ...
        process.env.NODE_ENV !== 'production' && vue.warn("Error decoding \"" + text + "\". Using original value");
    }
    return text;
}
...
function useLink(props) {
    ...
    var route = vue.computed(function () {
        return router.resolve(vue.isRef(props.to) ? props.to.value : props.to);
    });
    var href = vue.computed(function () { return router.createHref(route.value); });
    var isActive = vue.computed(function () { return router.currentRoute.value.path.indexOf(route.value.path) === 0; });
...
var Link = vue.defineComponent({
    ...
    setup: function (props, _a) {
        ...
        var _b = useLink(props), route = _b.route, isActive = _b.isActive, href = _b.href, navigate = _b.navigate;
        ...
        // TODO: handle replace prop
        return function () {
            return vue.h('a', __assign({ class: elClass.value, onClick: navigate, href: href.value }, attrs), slots.default(vue.reactive({ route: route, href: href, isActive: isActive })));
        };
    },
});
...
function createRouter(_a) {
    ...
    function pushWithRedirect(to, redirectedFrom) {
        return __awaiter(this, void 0, void 0, function () {
            var toLocation, from, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        toLocation = (pendingLocation = resolve(to));
