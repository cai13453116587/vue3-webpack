import { pauseTracking, resetTracking, isRef, toRaw, isReactive, unlock, lock, effect, stop, reactive, shallowReadonly, computed as computed$1 } from '@vue/reactivity';
...
import { isFunction, isString, isPromise, isArray, EMPTY_OBJ, isOn, EMPTY_ARR, extend, normalizeClass, isObject, normalizeStyle, isReservedProp, camelize, hasOwn, hyphenate, toRawType, capitalize, makeMap, NO, NOOP, remove, hasChanged } from '@vue/shared';
...
function createHydrationFunctions({ mt: mountComponent, p: patch, o: { patchProp, createText } }) {
    const hydrate = (vnode, container) => {
        ...
        flushPostFlushCbs();
        if (hasMismatch && !(process.env.NODE_ENV === 'test')) {
...
export { BaseTransition, Comment, Fragment, KeepAlive, Portal, Suspense, Text, callWithAsyncErrorHandling, callWithErrorHandling, cloneVNode, computed, createBlock, createCommentVNode, createHydrationRenderer, createRenderer, createSlots, createStaticVNode, createTextVNode, createVNode, defineComponent, getCurrentInstance, h, handleError, inject, mergeProps, nextTick, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onMounted, onRenderTracked, onRenderTriggered, onUnmounted, onUpdated, openBlock, popScopeId, provide, pushScopeId, registerRuntimeCompiler, renderList, renderSlot, resolveComponent, resolveDirective, resolveDynamicComponent, resolveTransitionHooks, setBlockTracking, setTransitionHooks, ssrContextKey, ssrUtils, toHandlers, useCSSModule, useSSRContext, useTransitionState, version, warn, watch, watchEffect, withDirectives, withScopeId };
