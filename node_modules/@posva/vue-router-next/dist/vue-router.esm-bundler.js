/*!
  ...
  * @license MIT
  */
import { markNonReactive, warn, inject, defineComponent, computed, h, reactive, isRef, provide, ref, nextTick, getCurrentInstance } from 'vue';
...
function useLink(props) {
    ...
    const route = computed(() => router.resolve(isRef(props.to) ? props.to.value : props.to));
    const href = computed(() => router.createHref(route.value));
    const isActive = computed(() => router.currentRoute.value.path.indexOf(route.value.path) === 0);
...
function createRouter({ history, routes, scrollBehavior, }) {
    ...
    function resolve(location, currentLocation) {
        ...
        let matchedRoute = matcher.resolve(hasParams
...
export { Link, START_LOCATION_NORMALIZED as START_LOCATION, View, createHashHistory, createHistory, createMemoryHistory, createRouter, onBeforeRouteLeave, useRoute, useRouter };
